...
#if CONFIG_DRIVERS_NOTERAM_TASKNAME_BUFSIZE > 0
        {
...
#endif
         , get_task_name(pid, ctx), get_pid(pid));
}
...
void sysmon_trace_dump_set_overwrite(bool enable)
{
  unsigned int mode;
